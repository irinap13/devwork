...
function onePageScroll(element, options) {
  ...
  _transformPage = function(el2, settings, pos, index, next_el) {
    ...
    if (index == '1') {
      $("#logo").css({"transform":"scale(1)", "-webkit-transition": "-webkit-transform 400ms linear"});
    } 
    else {
      $("#logo").css({"transform":"scale(0.8)", "-webkit-transition": "-webkit-transform 400ms linear"});
    }

    if ( _hasClass(body,'viewing-page-3') ) {
        $("#timeline .time_item").removeClass('animated zoomOut');
        setTimeout(function(){$("#timeline .time_item:nth-child(2)").addClass('animated zoomInDown')},200);
        setTimeout(function(){$("#timeline .time_item:nth-child(3)").addClass('animated zoomInUp')},400);
        setTimeout(function(){$("#timeline .time_item:nth-child(4)").addClass('animated zoomInDown')},600);
        setTimeout(function(){$("#timeline .time_item:nth-child(5)").addClass('animated zoomInUp')},800);
        
    }
    else {
      $("#timeline .time_item").addClass('animated zoomOut');
    }
